...
<input type="text" name="jwFirstName" id="First Name" value=""  class="input-block-level" placeholder="First Name" />
<input type="text" name="jwLastName" id="Last Name" value=""  class="input-block-level" placeholder="Last Name" />
<input type="text" name="jwDOB" id="DOB" value=""  class="input-block-level" placeholder="DOB" />
<input type="text" name="jwAddress" id="Address" value=""  class="input-block-level" placeholder="Address" />
<input type="text" name="jwCity" id="City" value=""  class="input-block-level" placeholder="City" />
<input type="text" name="jwState" id="State" value=""  class="input-block-level" placeholder="State" />
<input type="text" name="jwZip" id="Zip" value=""  class="input-block-level" placeholder="Zip" />
<input type="text" name="jwEmail" id="Email" value=""  class="input-block-level" placeholder="Email" />
<input type="text" name="jwCellNumber" id="Cell Number" value=""  class="input-block-level" placeholder="Cell Number" />
