...
<p>
Displaying Records&nbsp;<%=hdRsCurrentRecordFrom%> to <%=hdRsCurrentRecordTo%> of <%=hdRsTotalSummaryRecords%>
<br />
<%
	If hdRsTotalPages > 1 Then	'##display paging if more than one page worth of data.
		...
		For NAVLOOP = 1 TO hdRsTotalPages
			If NAVLOOP MOD 15 = 0 Then Response.Write("<br>") '## break appart the number for records returned 
